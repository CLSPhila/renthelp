    ...
    return(
        <Box>
            ...
            <ButtonOptionsField {...props}>
                <Button variant="secondary" key='yes' value='yes'>Yes</Button>
                <Button variant="secondary" key='no' value='no'>No, I am not.</Button>
            </ButtonOptionsField>
        </Box>
    )
}
...
export const RentalHousingType = (props) => {
    return(
      ...
      <ButtonOptionsField {...props}>
                <Button variant="secondary" key='private' value='private'>Private housing</Button>
                <Button variant="secondary" key='public' value='public'>Public housing.</Button>
            </ButtonOptionsField>
...
export const WestPhilly = (props) => {
    return(
      ...
      <ButtonOptionsField {...props}>
                <Button variant="secondary" key='yes' value='yes'>Yes</Button>
                <Button variant="secondary" key='no' value='no'>No, I do not.</Button>
            </ButtonOptionsField>
      </Box>
    )
}
...
export const Veteran  = (props) => {
    return(
      ...
      <ButtonOptionsField {...props}>
                <Button variant="secondary" key='yes' value='yes'>Yes</Button>
                <Button variant="secondary" key='no' value='no'>No</Button>
            </ButtonOptionsField>
      </Box>
    )
}
